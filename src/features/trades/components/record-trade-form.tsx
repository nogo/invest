    ...
    >
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Details about the security being traded</CardDescription>
        </CardHeader>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Transaction specifics</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="space-y-2">
            <form.Field
      ...
      <Card>
        <CardHeader>
          <CardTitle>Broker & Costs</CardTitle>
          <CardDescription>Execution details and fees</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="space-y-2">
            <form.Field
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Optional supplementary details</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-2">
            <form.Field
